              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" id="login-form">
                    ...
                    <button id="log" value="Login" class="btn btn-primary btn-user btn-block">
                      Login
                    </button>

                  </form>
                  <hr>
                  <div id="error-msg" class="alert alert-danger" role="alert">Invalid credentials, please try again</div>
